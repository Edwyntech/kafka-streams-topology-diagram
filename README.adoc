...
image::{badges}/Sur_LinkedIn-email?style=social&logo=linkedin&label=Arnault%20Le%20Prévost-Corvellec[link=https://www.linkedin.com/in/arnault-l-054ab18b/,window=_blank]
